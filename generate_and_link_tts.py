...
NOTE_TYPE = "Japanese Shared Deck"  # Replace with your note type
...
def fetch_notes():
    """Fetch all notes of the specified note type."""
    payload = {
        "action": "findNotes",
        "version": 6,
...
async def main():
    # Fetch all notes for the specified note type
    ...
    for i, note in enumerate(notes):
        ...
        audio_file = f"jap_edgetts_pyscrpt_{i + 1}.mp3"
